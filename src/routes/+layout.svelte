<script lang="ts">
  ...
  import { Home, Image, FileImage, Palette, FolderOpen, Settings } from '@lucide/svelte';
        ...
        {#each navItems as item}
          <li>
            <button
              ...
              class="w-full flex items-center px-4 py-3 text-left rounded-lg transition-colors duration-200 {isActive(item.path) 
